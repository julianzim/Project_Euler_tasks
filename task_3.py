...
#находим список делителей числа а (вычисление этого блока 
# занимает дохуя времени т.к. не оптимальный поиск делителей. 
# достаточно проверять числа не превышающие квадрата заданного.
# см. task_3_1)
